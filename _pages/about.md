...
<li id="paperdistance"> Yuhang Zhou, <B>Zhongyun Hua*</B>, "Continual Adversarial Defense with Anisotropic & Isotropic Pseudo Replay", in <B>IEEE/CVF Computer Vision and Pattern Recognition Conference (CVPR)</I></B>, 2024.</li>
	
<li id="paperdistance"> Qiuyu Duan, <B>Zhongyun Hua*</B>, Qing Liao, Yushu Zhang, LEO Yu Zhang, "Conditional Backdoor Attack via JPEG Compression", in <B>Thirty-Eighth AAAI Conference on Artificial Intelligence (AAAI)</I><B>, 2024.</li>
